module.exports = [
  ...
  // ===== プロ名台詞・ティザー：5問 =====
  { text: '【名台詞】2023 WorldsのT1対JDG準決勝ティザーで「All roads lead to me」と語った選手は？', ko: '【명대사】2023 월즈 T1 vs JDG 준결승 티저에서 “All roads lead to me”라고 말한 선수는?', options: ['Faker', 'Ruler', 'Gumayusi', 'Knight'], optionsKo: ['Faker', 'Ruler', 'Gumayusi', 'Knight'], answer: 0 },
  { text: '【名台詞】2023 WorldsでT1との対戦が決まった際、「God has abandoned us, but we will enjoy it」と語った選手は？', ko: '【명대사】2023 월즈에서 T1과의 대진이 정해졌을 때 “God has abandoned us, but we will enjoy it”이라고 말한 선수는?', options: ['Pyosik', 'CoreJJ', 'APA', 'Summit'], optionsKo: ['Pyosik', 'CoreJJ', 'APA', 'Summit'], answer: 0 },
  { text: '【名台詞】2024 WorldsのT1対Gen.G準決勝ティザーで、Chovyに向けて「Prove it」と語った選手は？', ko: '【명대사】2024 월즈 T1 vs Gen.G 준결승 티저에서 Chovy에게 “Prove it”이라고 말한 선수는?', options: ['Faker', 'Keria', 'Oner', 'Gumayusi'], optionsKo: ['Faker', 'Keria', 'Oner', 'Gumayusi'], answer: 0 },
  { text: '【名台詞】2024 Worlds決勝ティザーで「The fifth trophy is for you」と語った選手は？', ko: '【명대사】2024 월즈 결승 티저에서 “The fifth trophy is for you”라고 말한 선수는?', options: ['Faker', 'Bin', 'Keria', 'Zeus'], optionsKo: ['Faker', 'Bin', 'Keria', 'Zeus'], answer: 0 },
  { text: '【名台詞】2024 WorldsのT1対Gen.G準決勝ティザーで「T1 is the past, present, and future」と語った選手は？', ko: '【명대사】2024 월즈 T1 vs Gen.G 준결승 티저에서 “T1 is the past, present, and future”라고 말한 선수는?', options: ['Gumayusi', 'Faker', 'Keria', 'Chovy'], optionsKo: ['Gumayusi', 'Faker', 'Keria', 'Chovy'], answer: 0 }
];
